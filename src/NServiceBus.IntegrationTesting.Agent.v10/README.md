# NServiceBus.IntegrationTesting.AgentV10

The NServiceBus 10 agent for [NServiceBus.IntegrationTesting](https://github.com/mauroservienti/NServiceBus.IntegrationTesting).

Add this package to the `*.Testing` companion project that wraps a **NServiceBus 10** endpoint.
...
```xml
<PackageReference Include="NServiceBus.IntegrationTesting.AgentV10" Version="..." />
```
