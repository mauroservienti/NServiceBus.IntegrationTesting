# NServiceBus.IntegrationTesting.AgentV8

The NServiceBus 8 agent for [NServiceBus.IntegrationTesting](https://github.com/mauroservienti/NServiceBus.IntegrationTesting).

Add this package to the `*.Testing` companion project that wraps a **NServiceBus 8** endpoint.
...
```xml
<PackageReference Include="NServiceBus.IntegrationTesting.AgentV8" Version="..." />
```
